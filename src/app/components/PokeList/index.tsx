    ...
    <div className="w-full">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 w-full">
        {paginatedGroups[pagination].map((poke) => (
          <div
            key={poke.name}
            className=" relative flex flex-col items-center justify-center p-6 pt-2 bg-gray-400 rounded-b-md rounded-r-md shadow-md before:content-[''] before:absolute before:w-11/12 before:h-[10px] before:bg-gray-400 before:bottom-full before:left-0 before:rounded-t-md  after:content-[''] after:absolute after:w-full after:h-[20px] after:border-t-4 after:border-b-4 after:border-gray-600 after:top-[25px] after:left-0  after:z-0 "
          >
